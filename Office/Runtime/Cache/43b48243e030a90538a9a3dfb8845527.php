...
<table width="98%" border="0" style="margin:20px;" class="ListCategory">
  ...
  <tr>
    ...
    <?php else: ?>
      <p style="padding:4px 0;"><img src="__ROOT__/Uploads/<?php echo ($product["thumb"]); ?>" width="60" height="60"/> * 建议比例1:250*150
...
<table width="98%" border="0" style="margin:20px;" class="ListCategory">
  <tr>
    ...
    <td width="88%" height="35"><input name="ename" type="text" value="<?php echo ($product["ename"]); ?>" class="FormSmall" style="width: 320px;"> 
  <span style="color:#F00; font-size:12px;">*必填</span>
    </td>
  </tr>
