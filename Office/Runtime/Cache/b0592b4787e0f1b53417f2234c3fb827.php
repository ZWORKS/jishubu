...
body{background: url(../Public/images/blue_2010/bg.jpg) repeat-x top center; background-color:#000000;}
.login_box{margin:0 auto; width:1024px; height:725px; background:url(../Public/images/blue_2010/login_bg.png) no-repeat;}
.login_text{font-size:13px; color:#000000; width:270px; padding:320px 0px 0px 470px; line-height:22px;}
...
.code_bg{width:90px; border-right:1px solid #000000;}
-->
</style>
