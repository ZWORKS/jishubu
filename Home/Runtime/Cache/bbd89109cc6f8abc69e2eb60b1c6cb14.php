        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                <div class="list_box"> 
                    ...
                    <ul class="list_news">
                      <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$table,'lang'=>'c'));?>" title="<?php echo ($vo["title"]); ?>"><?php if(isset($vo['name'])): echo (mb_substr($vo["name"],0,40,'utf-8')); else: echo (mb_substr($vo["title"],0,40,'utf-8')); endif; ?></a><span class="news_time"><?php echo (date('Y-m-d',$vo["time"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>  
                    </ul>
