...
<html lang="zh-cn">
  <head>
    ...
    <title><?php echo ($name); ?>-<?php echo (C("seo_title")); ?></title>
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                <div class="list_box">
                  ...
                  <?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                      <h3><a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>$type,'lang'=>'c'));?>" target="_blank"><?php echo (redword($vo["title"],50,$name)); ?></a></h3><p class="tags_p"><?php echo (redword($vo["description"],200,$name)); ?></p>
