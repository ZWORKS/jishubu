           ...
           <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
              <div class="list_box">
                <h2 class="left_h1"><?php echo ($articlelist["name"]); ?></h2>
                  ...
                  <div class="contents">
                    <h1 class="contents_title"><?php echo ($article["title"]); ?></h1>
                ...
                <div class="list_related"> 
                   <h1 class="left_h1">相关新闻</h1>
                    <ul class="list_news related_news">
                      <?php if(is_array($related)): $i = 0; $__LIST__ = array_slice($related,0,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo W('Href',array('url'=>$vo['url'],'id'=>$vo['id'],'type'=>'New','lang'=>'c'));?>" title="<?php echo ($vo["title"]); ?>"><?php echo (mb_substr($vo["title"],0,80,'utf-8')); ?></a><span class="news_time"><?php echo (date('Y-m-d',$vo["time"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>        
                    </ul>
                </div>
        </div>
