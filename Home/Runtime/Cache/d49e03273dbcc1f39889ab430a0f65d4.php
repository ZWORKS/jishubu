...
<html lang="zh-cn">
  <head>
    ...
    <title>TAGS标签-<?php echo (C("seo_title")); ?></title>
    ...
    <div class="container">    
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
                <div class="list_box"> 
                  <h2 class="left_h1">TAGS标签</h2>

                   <div class="tags tags_list">
                    <?php if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a class="btn btn-default btn-sm" href="<?php echo W('Taghref',array('id'=>$vo['id'],'type'=>$vo['type'],'lang'=>'c'));?>" role="button" target="_blank"><?php echo ($vo["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                  </div>
