                ...
                <div class="list_box">
                  <h2 class="left_h1"><?php echo ($articlelist["name"]); ?></h2>
                    ...
                    <div class="contents">
                        ...
                        <p class="download_btn"><a href="__ROOT__/?m=common&a=down&name=<?php echo ($article["filename"]); ?>" class="btn btn-primary" role="button" target="_blank"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> &nbsp;点击下载 </a></p> 
